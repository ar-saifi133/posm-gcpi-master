  ...
  render() {
   return (
     <div className='images-grid'>
       {(!this.props.imagery.items || this.props.imagery.items.length === 0) && (
         <div className='image-layout'>
           <div className='image-layout-div'>
             <div className='upload-file-ctn'>Upload File</div>
             <div className='or-file-ctn'>or</div>
             <div className='upload-file-ctn'>Upload an Image</div>
           </div>
         </div>
       )}
